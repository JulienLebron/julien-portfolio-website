...
<body>
    ...
    <main class="main">
        <!--===== Home =====-->
        <div class="mention__container container">
            <h3>1. Présentation du site.</h3>
            <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie
                numérique, il est précisé aux utilisateurs du site www.julien-lebron.com l'identité des différents
                intervenants dans le cadre de sa réalisation et de son suivi :</p>
            <p>Propriétaire : Julien LEBRON – 3, rue Aristide Briand 77124 Villenoy</p>
            <p>Créateur : Julien LEBRON - www.julien-lebron.com</p>
            <p>Responsable publication : Julien LEBRON</p>
            <p>Webmaster : Julien LEBRON – lebron.pro.77@gmail.com</p>
            <p>Hébergeur : o2switch – Chem. des Pardiaux, 63000 Clermont-Ferrand, France</p>

            <h3>2. Conditions générales d'utilisation du site et des services proposés.</h3>
            <p>L'utilisation du site www.julien-lebron.com implique l'acceptation pleine et entière des conditions
                générales d'utilisation ci-après décrites. Ces conditions d'utilisation sont susceptibles d'être
                modifiées ou complétées à tout moment, les utilisateurs du site www.julien-lebron.com sont donc invités
            ...
            <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
                maintenance technique peut être toutefois décidée par www.julien-lebron.com, qui s'efforcera alors de
                communiquer préalablement aux utilisateurs les dates et heures de l'intervention.</p>
            <p>Le site www.julien-lebron.com est mis à jour régulièrement par Julien LEBRON. De la même façon, les
            ...
            <p>Le site www.julien-lebron.com a pour objet de fournir une information concernant l'ensemble des activités
                de la société.</p>
            <p>Julien LEBRON s'efforce de fournir sur le site www.julien-lebron.com des informations aussi précises que
                ...
                ces informations.</p>
            <p>Tous les informations indiquées sur le site www.julien-lebron.com sont données à titre indicatif, et sont
                susceptibles d'évoluer. Par ailleurs, les renseignements figurant sur le site www.julien-lebron.com ne
            ...
            <p>Julien LEBRON est propriétaire des droits de propriété intellectuelle ou détient les droits d'usage sur
            ...
            <p>Julien LEBRON ne pourra être tenu responsable des dommages directs et indirects causés au matériel de
                l'utilisateur, lors de l'accès au site www.julien-lebron.com, et résultant soit de l'utilisation d'un
            ...
            <p>Julien LEBRON ne pourra également être tenu responsable des dommages indirects (tels par exemple qu'une
                perte de marché ou perte d'une chance) consécutifs à l'utilisation du site www.julien-lebron.com.</p>

            <p>Des espaces interactifs (possibilité de poser des questions dans l'espace contact) sont à la disposition
                des utilisateurs. Julien LEBRON se réserve le droit de supprimer, sans mise en demeure préalable, tout
                contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier
                aux dispositions relatives à la protection des données. Le cas échéant, Julien LEBRON se réserve
                ...
                le support utilisé (texte, photographie…).</p>
            ...
            <p>À l'occasion de l'utilisation du site www.julien-lebron.com, peuvent êtres recueillies : l'URL des liens
                par l'intermédiaire desquels l'utilisateur a accédé au site www.julien-lebron.com, le fournisseur
                d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>

            <p>En tout état de cause Julien LEBRON ne collecte des informations personnelles relatives à l'utilisateur
                que pour le besoin de certains services proposés par le site www.julien-lebron.com. L'utilisateur
                fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur
                saisie. Il est alors précisé à l'utilisateur du site www.julien-lebron.com l'obligation ou non de
            ...
            <p>Aucune information personnelle de l'utilisateur du site www.julien-lebron.com n'est publiée à l'insu de
                l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule
                l'hypothèse du rachat de Julien LEBRON et de ses droits permettrait la transmission des dites
                informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation .
                et de modification des données vis à vis de l'utilisateur du site www.julien-lebron.com.</p>
            ...
            <p>Le site www.julien-lebron.com contient un certain nombre de liens hypertextes vers d'autres sites, mis en
                place avec l'autorisation de Julien LEBRON. Cependant, Julien LEBRON n'a pas la possibilité de vérifier
                le contenu des sites ainsi visités, et n'assumera en conséquence aucune responsabilité de ce fait.</p>

            <p>La navigation sur le site www.julien-lebron.com est susceptible de provoquer l'installation de cookie(s)
                sur l'ordinateur de l'utilisateur. Un cookie est un fichier de petite taille, qui ne permet pas
            ...
            <p>Le refus d'installation d'un cookie peut entraîner l'impossibilité d'accéder à certains services.
                ...
                Bloquer tous les cookies. Validez sur Ok. <br>
            ...
            <p>PHPSESSID : Cookie de session propre à PHP</p>
            <p>Autres cookies :</p>
            <p>_ga, _gat : Cookies propres à Google Analytics (statistiques)</p>

            <h3>9. Droit applicable et attribution de juridiction.</h3>
            <p>Tout litige en relation avec l'utilisation du site www.julien-lebron.com est soumis aux tribunaux
                francais compétents statuant selon le droit français.</p>
